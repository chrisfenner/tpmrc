...
var $author$project$Main$init = {a: 0};
...
var $author$project$Main$normalize = function (input) {
	...
	while (true) {
		if ($elm$core$String$isEmpty(input)) {
			...
			if (A2($elm$core$String$startsWith, '0', input)) {
				var $temp$input = A2($elm$core$String$dropLeft, 1, input);
				input = $temp$input;
				continue normalize;
			} else {
				if ($elm$core$String$length(input) > 4) {
					return A2($elm$core$String$left, 4, input);
				} else {
					return input;
				}
			}
				...
				model,
				{
					a: A2(
						...
						$elm$core$String$toInt(
							$author$project$Main$normalize(newCode)))
				});
		} else {
			var newCode = msg.a;
			return _Utils_update(
...
var $author$project$Main$ChangeDec = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$ChangeHex = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$Fmt0 = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$Fmt1 = function (a) {
	return {$: 1, a: a};
};
var $elm$core$Bitwise$and = _Bitwise_and;
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$decodeType0 = function (raw) {
	var warning = !(!(raw & 2048));
	var vendor = !(!(raw & 1024));
	var code = raw & 383;
	return {a: code, ak: vendor, F: warning};
};
var $author$project$Main$Handle = 0;
var $author$project$Main$Parameter = 1;
var $author$project$Main$Session = 2;
var $elm$core$Basics$ge = _Utils_ge;
var $elm$core$Basics$not = _Basics_not;
var $elm$core$Bitwise$shiftRightBy = _Bitwise_shiftRightBy;
var $author$project$Main$decodeType1 = function (raw) {
	var parameter = !(!(raw & 64));
	var paramNum = (raw & 3840) >> 8;
	var session = parameter ? false : ((paramNum >= 8) ? true : false);
	var sessionNum = paramNum - 8;
	var handleNum = 7 & paramNum;
	var handle = parameter ? false : (!session);
	var code = raw & 63;
	var assocNum = parameter ? paramNum : (session ? sessionNum : handleNum);
	var assoc = parameter ? 1 : (session ? 2 : 0);
	return {G: assoc, H: assocNum, a: code};
};
var $author$project$Main$decode = function (code) {
	var isType1 = !(!(code & 128));
	return isType1 ? $author$project$Main$Fmt1(
		$author$project$Main$decodeType1(code)) : $author$project$Main$Fmt0(
		$author$project$Main$decodeType0(code));
};
...
var $author$project$Main$fmt0Name = function (code) {
	switch (code) {
		case 0:
		...
		default:
			return '<unknown format-0 code 0x' + ($rtfeldman$elm_hex$Hex$toString(code) + '>');
	}
};
var $author$project$Main$fmt0Warning = function (code) {
	switch (code) {
		case 257:
		...
		default:
			return '<unknown format-1 warning 0x' + ($rtfeldman$elm_hex$Hex$toString(code + 2304) + '>');
	}
};
var $author$project$Main$fmt1Name = function (code) {
	switch (code) {
		case 1:
		...
		default:
			return '<unknown format-1 code 0x' + ($rtfeldman$elm_hex$Hex$toString(code) + '>');
	}
};
var $author$project$Main$fmt = function (rc) {
	if (!rc.$) {
		var rc0 = rc.a;
		return rc0.F ? $author$project$Main$fmt0Warning(rc0.a) : $author$project$Main$fmt0Name(rc0.a);
	} else {
		var rc1 = rc.a;
		return $author$project$Main$fmt1Name(rc1.a) + (' (' + (function () {
			var _v1 = rc1.G;
			switch (_v1) {
				case 1:
					return 'Parameter';
		...
		}() + (' ' + ($elm$core$String$fromInt(rc1.H) + ')'))));
	}
};
var $elm$html$Html$input = _VirtualDom_node('input');
var $author$project$Main$isWarning = function (code) {
	var decoded = $author$project$Main$decode(code);
	if (!decoded.$) {
		var rc0 = decoded.a;
		return rc0.F;
	} else {
...
var $author$project$Main$isError = function (code) {
	return (!code) ? false : (!$author$project$Main$isWarning(code));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('decoder', true),
						_Utils_Tuple2('success', !model.a),
						_Utils_Tuple2(
						'warning',
						$author$project$Main$isWarning(model.a)),
						_Utils_Tuple2(
						'error',
						$author$project$Main$isError(model.a))
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Main$ChangeDec)
							]),
						_List_Nil)
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('0'),
								$elm$html$Html$Attributes$value(
								$rtfeldman$elm_hex$Hex$toString(model.a)),
								$elm$html$Html$Events$onInput($author$project$Main$ChangeHex)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$fmt(
							$author$project$Main$decode(model.a)))
					]))
			]));
};
